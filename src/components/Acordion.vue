<template lang="pug">
.acordion
  .tarjeta.tarjeta--lavanda.mb-4.pb-0(v-for="elm of elements" :key="elm.id")
    
    .acordion__header(@click="selected = selected != elm.id ? elm.id : 0")
      .acordion__accion
        img(v-if="selected != elm.id" src="@/assets/curso/tema_2/img_15.svg")
        img(v-else src="@/assets/curso/tema_2/img_16.svg")
      .acordion__titulo
        .p.mb-0 {{elm.titulo}}
